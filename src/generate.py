...
def evaluate(dataloader, tokenizer, device, ctx, model, max_new_tokens):
    ...
    return accuracy, throughput, total_instances, total_time
...
def main():
    ...
    accuracy, throughput, total_instances, total_time = evaluate(test_dataloader, tokenizer, device, ctx, model, args.max_new_tokens)
    print (f"Test Accuracy: {accuracy}. Throughput: {throughput}. Total instance: {total_instances}. Total time: {total_time}")
